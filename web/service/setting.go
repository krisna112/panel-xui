...
func (s *SettingService) GetAutoDeleteDepletedClients() (bool, error) {
	str, err := s.getString("autoDeleteDepletedClients")
	if database.IsNotFound(err) {
		return false, nil
	}
	if err != nil {
...
func (s *SettingService) GetAutoDeleteDepletedClientsDays() (int, error) {
	str, err := s.getString("autoDeleteDepletedClientsDays")
	if database.IsNotFound(err) {
		return 7, nil
	}
	if err != nil {
