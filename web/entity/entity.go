...
type AllSetting struct {
	...
	// Client auto cleanup
	AutoDeleteDepletedClients     bool `json:"autoDeleteDepletedClients" form:"autoDeleteDepletedClients"`         // Enable auto-deletion of depleted clients
	AutoDeleteDepletedClientsDays int  `json:"autoDeleteDepletedClientsDays" form:"autoDeleteDepletedClientsDays"` // Grace period before deleting depleted clients (days)
