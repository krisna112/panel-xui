...
Inbound.VmessSettings.VMESS = class extends XrayCommonClass {
    ...
    get _limitDaily() {
        return NumberFormatter.toFixed(this.limitDaily / SizeFormatter.ONE_MB, 2);
    }

    set _limitDaily(mb) {
        this.limitDaily = NumberFormatter.toFixed(mb * SizeFormatter.ONE_MB, 0);
    }
...
Inbound.ShadowsocksSettings.Shadowsocks = class extends XrayCommonClass {
    ...
    get _limitDaily() {
        return NumberFormatter.toFixed(this.limitDaily / SizeFormatter.ONE_GB, 2);
    }

    set _limitDaily(gb) {
        this.limitDaily = NumberFormatter.toFixed(gb * SizeFormatter.ONE_GB, 0);
    }
